...
AABSection::AABSection()
{
	...
	FString GateAssetPath = TEXT("/Game/InfinityBladeGrassLands/Maps/Book/Chapter1/StaticMesh/SM_GATE.SM_GATE");
	static ConstructorHelpers::FObjectFinder<UStaticMesh> SM_GATE(*GateAssetPath);

	if(!SM_GATE.Succeeded())
	{
		ABLOG(Error, TEXT("Failed to load staticmesh assset. : %s"), *GateAssetPath);
	}
